...
import { X, Calendar, TrendingUp, TrendingDown, ArrowRightLeft } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-[var(--divider)]">
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-[var(--text-primary)]">Xem trước giao dịch</h2>
            <p className="text-sm text-[var(--text-secondary)] mt-1">{ruleName}</p>
          </div>
          <button
            onClick={onClose}
          ...
          <Card className="bg-[var(--surface)]">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm text-[var(--text-secondary)] mb-1">Tổng ảnh hưởng</p>
                <p
                  className={`text-xl font-bold tabular-nums ${
                    totalAmount >= 0 ? 'text-[var(--success)]' : 'text-[var(--danger)]'
                  }`}
                >
                  {totalAmount >= 0 ? '+' : ''}
        ...
        <div className="p-6 border-t border-[var(--divider)] space-y-3">
          <div className="flex items-center justify-between text-sm text-[var(--text-secondary)]">
            <span>Đã chọn {selectedTransactions.size}/{transactions.length} giao dịch</span>
          ...
          <div className="flex flex-col-reverse md:flex-row gap-3">
            <Button onClick={onClose} variant="secondary" className="flex-1 md:flex-initial">
              Huỷ
            </Button>
            <Button
