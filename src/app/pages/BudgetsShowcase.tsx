      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div>
          ...
          <p className="text-gray-600">
            Complete budget management system with month selector, progress tracking, and item management
          </p>
        </div>
        ...
        <section>
          ...
          <div className="mb-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-2xl border border-gray-300">
              <div className="bg-white relative" style={{ width: '1440px', height: '900px', transform: 'scale(0.7)', transformOrigin: 'top left' }}>
                <div style={{ width: '1440px', height: '900px', transform: 'scale(1.43)' }}>
                  <Layout title="Tạo ngân sách">
          ...
          <div className="mb-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-2xl border border-gray-800">
              <div className="dark bg-[#0f1113] relative" style={{ width: '1440px', height: '900px', transform: 'scale(0.7)', transformOrigin: 'top left' }}>
                <div style={{ width: '1440px', height: '900px', transform: 'scale(1.43)' }}>
                  <Layout title="Tạo ngân sách">
                    <CreateEditBudget mode="edit" />
                  </Layout>
